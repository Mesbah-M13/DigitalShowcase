...
const Page2 = () => {
  ...
  // });
  useGSAP(() => {
    gsap.utils.toArray(".animeText").forEach((el) => {
      gsap.from(el, {
        rotateX: -80,
        opacity: 0,
        duration: 2,
  ...
  return (
    <div id="section2" className="bg-white text-center p-10 md:p-20 text-black">
      <div className="animeText ">
        <h1 className="md:text-[40vw]text-[40vw] text-[30vw]  text-black font-[font0] leading-[30vw]">
          IMPACTFUL
        </h1>
      </div>
      <div className="animeText ">
        <h1 className="md:text-[40vw] text-[30vw]  text-black font-[font0] leading-[30vw]">
          DESIGN
        </h1>
      </div>
      <div className="animeText ">
      ...
      <div className="flex items-center justify-center scale-75 mt-20">
        {/* ... ICONS are here ... */}
        <svg
          ...
          <g>
            ...
            <defs fill="none">
              ...
              >
                ...
                <feBlend
                  result="effect1_dropShadow_206_3"
                  in2="BackgroundImageFix"
                ></feBlend>
                <feBlend
                  result="shape"
                  in2="effect1_dropShadow_206_3"
                  in="SourceGraphic"
                ></feBlend>
              </filter>
              <filter
              ...
              <clipPath id="96a8edfe-3cce-4a8a-8fa1-014070af92c2_comp-lmyox36t2">
                <path
                  transform="translate(705.812 5)"
                  fill="#ffffff"
                  d="M433 0v73H0V0h433z"
                ></path>
              </clipPath>
            </defs>
          </g>
      ...
      <div className="h-1 w-1/3 relative left-1/2 mt-20 -translate-x-1/2 bg-black"></div>
    </div>
  );
};
